...
VALIDITY() {
    ...
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mLicensi Aktif @givpn\e[0m"
        sleep 5
    else
...
echo " "
echo -e "\e[1;32m══════════════════Autoscript givpn══════════════════\e[0m" | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript By givpn══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         Premium By givpn             |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
